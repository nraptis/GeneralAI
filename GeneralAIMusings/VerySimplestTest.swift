...
func b() {
    ...
    outputByte1.bit1.value = false
    outputByte1.bit2.value = true
    outputByte1.bit3.value = true
    outputByte1.bit4.value = false
    outputByte1.bit5.value = false
    outputByte1.bit6.value = true
